...
Given I have courses titled "Java I, Ruby I, Fortran I"
	...
	|	id	|	course		|	start_time	|	end_time	|	date			|	teacher				|
	|	1		|	Java I		|	11:00				| 12:00			|	08/26/09	|	johan_sveholm	|
	|	2		|	Java I		|	11:00				| 13:00			|	08/26/09	|	komatsu_aya		|
...
Given I go to the list of classes
	And I should not see "Fortran"'blank''course'
...
Given I go to the "08/26/2009" list of classes
	And I should see 'klasses.listing'" - Wednesday"
	And I should have 2 classes
When I follow 'delete' within "klass_2"
Then I should be redirected to the list of classes
	And I should see 'klasses.listing'" - Wednesday"
