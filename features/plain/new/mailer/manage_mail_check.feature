...
Given a klass: "6" exists with date: "2010-04-06", course: course "2", start_time: "12:00", end_time: "12:50"
	...
	And a courses_teacher exists with course: course "1", teacher: user "<user>"
	And a courses_teacher exists with course: course "2", teacher: user "<user>"
...
Given a klass: "6-1" exists with date: "2010-04-06", course: course "2", start_time: "12:00", end_time: "12:50"
	...
	And a courses_teacher exists with course: course "1", teacher: user "aya"
	And a courses_teacher exists with course: course "2", teacher: user "aya"
...
Given a course: "nyuumon" exists with name: "入門 I"
	...
	And a courses_teacher exists with course: course "1", teacher: user "<user>"
	And a courses_teacher exists with course: course "2", teacher: user "<user>"
	And a courses_teacher exists with course: course "nyuumon", teacher: user "<user>"
