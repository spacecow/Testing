...
Given a setting exist with name: "main"
	...
	And a course: "ruby" exists with name: "Ruby II", capacity: "6"
	And a course: "rails" exists with name: "Rails II", capacity: "6"
...
When I go to the template classes page
	And I select "Monday" as day in the select menu
Then "Monday" should be selected as day in the select menu
...
When I select "Tuesday" as day in the select menu
...
Given a course: "ruby2" exists with name: "Ruby I", capacity: "8"
	And a user is logged in as "aya"
When I go to the template classes page
Then 2 template_classes should exist
When I select "Monday" as day in the select menu
