...
Given a course: "ruby" exists with name: "Ruby I"
	...
	And a teaching exists with course: course "ruby", teacher: user "johan"
	And a teaching exists with course: course "ruby", teacher: user "aya"
	And a teaching exists with course: course "ruby", teacher: user "prince"
	And a teaching exists with course: course "rails", teacher: user "johan"
	And a teaching exists with course: course "rails", teacher: user "prince"
...
Given a course: "ruby" exists with name: "Ruby I"
	...
	And a teaching exists with course: course "rails", teacher: user "johan"
	And a teaching exists with course: course "rails", teacher: user "prince"
	And a teaching exists with course: course "fortran", teacher: user "aya"
	And a klass: "ruby" exists with course: course "ruby", start_time: "18:50", end_time: "20:50", date: "2010-02-28"
