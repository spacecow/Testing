...
Given a setting exist with name: "main"
	And a user: "johan" exist with username: "johan", role: "god, teacher", language: "en", name: "Johan Sveholm", cost: "0"
...
Scenario: Cost must be given
Given a user is logged in as "johan"
When I browse to the teachers page
	And I follow "Courses" within user "aya"
	And I check "Ruby III"
	And I press "Update"
...
Given a user is logged in as "aya"
	And a courses_teacher exists with course: course "ruby", teacher: user "johan", chosen: true
	And a courses_teacher exists with course: course "fortran", teacher: user "johan", chosen: true
	Then 2 courses_teachers should exist
When I browse to the teachers page
	And I follow "Courses" within user "johan"
Then the "Ruby III" checkbox should be checked
  And the "Rails II" checkbox should not be checked
...
@allow-rescue
Scenario Outline: Non-admins cannot set courses
