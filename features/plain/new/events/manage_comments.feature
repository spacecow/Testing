...
Then I should see "Fuck Christmas!"
	And a comment exists with comment: "I wanna chat!", user: user "kurosawa", event: event "christmas", todo_id: "nil"
...
When I go to the show page of event "christmas"
Then I should <aya> within comment "fuck_santa"
  And I should <kurosawa> within comment "fuck_christmas"
