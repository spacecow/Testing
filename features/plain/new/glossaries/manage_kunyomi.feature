...
Given a setting exist with name: "main"
	...
	And a word: "ki" exists with japanese: "黄", reading: "き", meaning: "yellow (P)"
	And a word: "kiromi" exists with japanese: "黄み", reading: "きろみ", meaning: "yellowish"
	...
	And a kunyomi: "kiromi" exists with reading: "きろ.み"
...
Scenario: A kunyomi that does not exist or is not marked as (P) as word should not be displayed
