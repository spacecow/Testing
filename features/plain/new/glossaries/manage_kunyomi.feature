...
Given a setting exist with name: "main"
	...
	And a word: "obi" exists with japanese: "帯", reading: "おび", meaning: "(n) sash"
	And a word: "obiru" exists with japanese: "帯びる", reading: "おびる", meaning: "to wear"
	...
	And kunyomi "ki, kiro" are kanji "yellow"'s kunyomis
...
@meaning
Scenario: After kunyomi comes meaning
