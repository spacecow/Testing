ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :users, :member => { :reserve=>:get, :new_event_register => :post, :create_event_register => :put, :edit_role => :get, :update_role => :put }, :collection => { :change_password => :get, :update_password => :put }
