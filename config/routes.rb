ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :users, :member => { :edit_courses=>:get, :reserve=>:get, :new_event_register => :post, :create_event_register => :put, :edit_role => :get, :update_role => :put }, :collection => { :edit_multiple => :post, :update_multiple =>:put, :change_password => :get, :update_password => :put }
